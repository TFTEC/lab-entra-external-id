...
|---|-------|-------|------------------|---------|
| 1 | Tenant externo do aluno não criado ou ainda provisionando | `Manage tenants` mostra o tenant com status de criação; alternar diretório falha | Criar agora (`docs/pre-aula.md`); provisionamento leva até 30 min | Plano B padrão até o tenant ficar pronto; aluno retoma no módulo em que a sala estiver |
